...
#define D_SERVICE			0	/* 默认connect way */
...
#endif
static const char *CFG_FILE = "/etc/storage/mentohust.conf";	/* 配置文件 */
...
unsigned service = D_SERVICE ; /* service connect way*/
